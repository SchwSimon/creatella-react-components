...
export default class ItemPickerView extends PureComponent {
  constructor(props) {
    ...
    this.REF_CONTAINER = /*#__PURE__*/React.createRef();
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      size: 20
    })), selectedItems.length ? selectedItems.map(this.renderItem) : !!(!isProcessing && (isSingleSelection || !isRenderInput)) && /*#__PURE__*/React.createElement("div", {
      className: `
