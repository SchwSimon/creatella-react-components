...
window._ItemPickerView = {
  defaultProps: { ...ItemPickerGlobalDefaultProps,
    classNameValid: '',
    classNameInvalid: '',
    classNameDropdown: '',
    isItemPicker: true,
...
export default class ItemPickerView extends PureComponent {
  ...
  render() {
    ...
    return React.createElement("div", {
      ...
      onClick: onClickFunc
    }, childrenToggle || React.createElement(FontAwesomeIcon, {
      icon: faCaretDown
...
_defineProperty(ItemPickerView, "defaultProps", window._ItemPickerView.defaultProps);