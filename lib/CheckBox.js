...
export default class CheckBox extends PureComponent {
  ...
  render() {
    ...
    }, isSwitch ? React.createElement("div", {
      className: `CheckBox__switch ${isChecked ? 'CheckBox__switch--checked' : ''}`
    }, React.createElement("div", {
      className: `CheckBox__switch-dot ${isChecked ? 'CheckBox__switch-dot--checked' : ''}`
    })) : React.createElement("div", {
