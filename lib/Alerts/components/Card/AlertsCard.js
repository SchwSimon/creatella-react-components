...
export default class AlertsCard extends PureComponent {
  constructor(props) {
    ...
    _defineProperty(this, "onUpdateTime", () => {
      ...
      this.setState({
        timeDisplay: formatDistanceStrict(timestamp, new Date(), {
          addSuffix: true
        })
      });
    });
  ...
  render() {
    ...
    }, timeDisplay), isMouseHandlers && React.createElement(Button, {
    ...
    }, isAutoDismiss && React.createElement("div", {
...
_defineProperty(AlertsCard, "defaultProps", {
  isAutoDismiss: true,
